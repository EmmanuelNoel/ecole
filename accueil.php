        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item active fs-5">
              <a class="nav-link gx-3 fw-bold" href="accueil.php">Accueil</a>
            </li>
            <li class="nav-item fs-5">
              <a class="nav-link fw-bold" href="inscription.html">Inscription</a>
            </li>
            <li class="nav-item fs-5">
              <a class="nav-link fw-bold" href="index.php">Connexion</a>
            </li>
...
<div class="mt-4 mb-3 p-3 m-3"></div>

    <div class="container px-3 mt-4  ">
        <div class="row">
            <div class="text-center">
                <img src="image.gif" alt="" class="fluid" width="20%">
            </div>
        </div>
